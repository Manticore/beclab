...
.. py:module:: beclab.integrator

This sub-package exposes low-level integrator API.
These objects make minimal assumptions about the actual equation being integrated.
